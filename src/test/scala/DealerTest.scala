...
class DealerTest extends PokerTest {
  ...
  "a dealer" should {
    ...
    val dealer = makeDealer(List(1000, 1000, 800))
    ...
    "have blinds, turnToAct etc." in {
      ...
      dealer.lastFullRaise must_== Chips(2)
    }
    ...
    "have player acts" in {
      ...
      "not allow raise less than last full raise" in {
        ...
        dealer.raise(1) must beNone
      }

      "not allow raise more than stack" in {
        dealer.raise(998) must beNone
      }

      "allow raise at least last full raise" in {
        dealer.raise(2) must beDealer("""
P 0 0 2!0 0 1 2
I 996 4 RR2
I 999 1 .
I 798 2 .
...
T 0 2 100!300 0 2 3 4~625 0 1 2 3 4
I 50 0 .
O 0 0 .
I 200 0 .
O 0 0 .
...
F 0 4 10!50 0 4~75 0 1 4~100 0 1 2 4~125 0 1 2 3 4
O 0 0 .
O 0 0 .
O 0 0 .
O 0 0 .
...
"""
        ...
        Some(dealer.nextRound) must beDealer("""
T 0 4 10!40 4 5~75 0 4 5~100 0 1 4 5~125 0 1 2 4 5~150 0 1 2 3 4 5
O 0 0 .
O 0 0 .
O 0 0 .
O 0 0 .
...
"""
        ...
        Some(dealer.nextRound) must beDealer("""
T 0 4 10!40 4 5~75 0 4 5~100 0 1 4 5~125 0 1 2 4 5~250 0 1 2 3 4 5
O 0 0 .
O 0 0 .
O 0 0 .
O 0 0 .
...
"""
        ...
        Some(dealer.nextRound) must beDealer("""
T 0 4 10!40 4 5~80 0 4 5~125 0 1 4 5~150 0 1 2 4 5~275 0 1 2 3 4 5
O 0 0 .
O 0 0 .
O 0 0 .
O 0 0 .
...
"""
        ...
        Some(dealer.nextRound) must beDealer("""
T 0 4 10!50 4 5~105 0 4 5~150 0 1 4 5~175 0 1 2 4 5~300 0 1 2 3 4 5
O 0 0 .
O 0 0 .
O 0 0 .
O 0 0 .
...
"""
      ...
      "distribute all" in {
        val dealer = Visual << """
T 0 4 10!50 4 5~105 0 4 5~300 0 1 2 3 4 5
O 0 0 .
O 0 0 .
O 0 0 .
O 0 0 .
...
"""
      ...
      "distribute all with folded side pots" in {
        val dealer = Visual << """
T 0 4 10!50 4 5~105 0 4 5 7~300 0 1 2 3 4 5 6 7
O 0 0 .
O 0 0 .
O 0 0 .
O 0 0 .
